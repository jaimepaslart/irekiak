 ...
 * the DB, and as seed content for the admin editor's first load.
 */
export const defaultAnnouncement: AnnouncementConfig = {
  ...
  paragraphs: [
    ...
    {
      eu: 'Horregatik erabaki du **DAGGE**, Donostiako Arte Garaikideko Galerien Elkarteak, hemendik aurrera ekitaldi hau maiatzean ospatzea urtero. IREKIAK Gallery Weekend bere **VI. edizioan** berrantolatzen da, Donostiako esparru sozial, turistiko eta kulturalean urteroko arte hitzordu giltzarri bihurtzeko helburuarekin.',
      es: 'Es por esta razón que **DAGGE**, Asociación de Galerías de Arte Contemporáneo de Donostia ha decidido celebrar este acontecimiento a partir de ahora, cada año durante los meses de mayo. IREKIAK Gallery Weekend se reprograma en su **VI edición** con el objetivo de convertirse en una cita artística anual, clave en el ámbito social, turístico y cultural de San Sebastián.',
      fr: 'C\'est pour cette raison que **DAGGE**, l\'Association des Galeries d\'Art Contemporain de Donostia, a décidé de tenir cet événement dorénavant chaque année au mois de mai. IREKIAK Gallery Weekend se reprogramme pour sa **VIe édition** avec l\'objectif de devenir un rendez-vous artistique annuel, clé dans le paysage social, touristique et culturel de Saint-Sébastien.',
      en: 'For this reason, **DAGGE**, the Association of Contemporary Art Galleries of Donostia, has decided to hold this event every year during May from now on. IREKIAK Gallery Weekend is being rescheduled for its **6th edition** with the aim of becoming a yearly artistic event, central to the social, tourist and cultural life of San Sebastián.',
    },
    {
      eu: 'Irekiera **maiatzaren 29an** izango da, asteburu osoan zehar ateak zabalik izango dituen programa erakusketa trinko batekin; arte, artista, hiritar eta bisitariekin topaketa erakargarri bat, era familiar batean galerien espazioak eta aurkezten duten artisten lana ezagutu nahi dutenentzat.',
      es: 'La apertura tendrá lugar el próximo **29 de mayo** con un intenso programa expositivo de puertas abiertas a lo largo del fin de semana; un atractivo encuentro con el arte, artistas, ciudadanía y visitantes que quieran conocer de una forma familiar los espacios de las galerías y la obra de los artistas que presentan.',
      fr: 'L\'ouverture aura lieu le **29 mai**, avec un programme dense de portes ouvertes tout au long du week-end ; une rencontre attrayante avec l\'art, les artistes, les habitants et les visiteurs qui souhaitent découvrir de manière familière les espaces des galeries et l\'œuvre des artistes qu\'elles présentent.',
      en: 'The opening will take place on **May 29th** with an intense open-doors programme running throughout the weekend; a warm encounter with art, artists, residents and visitors who wish to discover the galleries\' spaces and the work of the artists they showcase.',
    },
  ],
}
